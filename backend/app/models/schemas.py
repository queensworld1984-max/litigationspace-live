...
class CaseCreate(BaseModel):
    ...
    case_type: str = "other"
    jurisdiction: Optional[str] = None       # e.g. "USA", "Uganda", "UK"
    forum: Optional[str] = None              # e.g. "USCIS", "EOIR", "High Court"
    matter_type: Optional[str] = None        # e.g. "I-485", "Removal Proceedings"
    party_roles: Optional[str] = None        # JSON: {"petitioner": "John", "beneficiary": "Jane"}
    status: Optional[str] = None             # accept status from frontend
